...
Motor_PID DC[5] = {
		Motor_PID(&huart4, 0x03,450), // DC 0
		Motor_PID(&huart4, 0x04,-450), // DC 1
		Motor_PID(&huart4, 0x05,450), // DC 2
		Motor_PID(&huart4, 0x06,-450), // DC 3
		Motor_PID(GPIOB , GPIO_PIN_7, &htim1, TIM_CHANNEL_1, 450)

};


Module_shot DC_SHOT[2] = {
/*XOAY MAM*/	Module_shot(&huart4, 0x10, 6750,-5400,5400,&htim5,20000),
/*CHINH GOC */	Module_shot(&huart4, 0x09, 26400,-25000,25000,&htim3,20000)
...
//	  int16_t en_1 = __HAL_TIM_GET_COUNTER(&htim2);
//	  int16_t en_2 = __HAL_TIM_GET_COUNTER(&htim5);
//	  int16_t en_3 = __HAL_TIM_GET_COUNTER(&htim3);
...
//	  Debug("encoder goc ban : %d   angle_module : %d",DC_SHOT[1].encoder_module,DC_SHOT[1].angle_module);
	 // Debug("encoder goc ban = %d   counter = %d  level_couter = %d",DC_SHOT[1].encoder_module,en_3,DC_SHOT[1].level_count);
	  ...
	  dap_bong();
	  ban_bong();
  	  //__HAL_TIM_SET_COMPARE(&htim4,TIM_CHANNEL_1,299);
//	  int16_t angle = compass();
//	  char flag = '{';
...
//		  timer = HAL_GetTick();
//	  }
//	  HAL_UART_Transmit(&huart3, (uint8_t*)&flag,1, 10);
//	  HAL_UART_Transmit(&huart3,(uint8_t*)&angle ,2, 10);
